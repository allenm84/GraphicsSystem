...
namespace MLA.Graphics
{
  ...
  /// </summary>
  [Serializable]
  public struct MgSizeF
  {
    /// <summary>
    /// Initializes an empty size.
    /// </summary>
    public static readonly MgSizeF Empty;
    ...
    public MgSizeF(float width, float height)
    {
      this.width = width;
      this.height = height;
    }
    ...
    /// </summary>
    public static MgSizeF operator +(MgSizeF sz1, MgSizeF sz2)
    {
      return Add(sz1, sz2);
    }
    ...
    /// </summary>
    public static bool operator ==(MgSizeF sz1, MgSizeF sz2)
    {
    ...
    /// </summary>
    public static explicit operator MgVector2(MgSizeF size)
    {
      return new MgVector2(size.Width, size.Height);
    }

    /// <summary>
    /// Scales a size by a factor.
    /// </summary>
    public static MgSizeF operator *(MgSizeF value, float scaleFactor)
    {
    ...
    /// Scales a size by a factor.
    /// </summary>
    public static MgSizeF operator *(float scaleFactor, MgSizeF value)
    {
      return Multiply(value, scaleFactor);
    }
    ...
    /// Scales a size by a factor.
    /// </summary>
    public static MgSizeF operator /(MgSizeF value, float divider)
    {
    ...
    /// <summary>
    /// </summary>
    public static implicit operator MgSizeF(MgVector2 v)
    {
      return new MgSizeF(v.X, v.Y);
    }
    ...
    public static MgSizeF Multiply(MgSizeF value, float scaleFactor)
    {
      var size = new MgSizeF();
    ...
    /// <returns>The product of the size and the scale.</returns>
    public static MgSizeF Divide(MgSizeF value, float divider)
    {
      var num = 1f / divider;
    ...
    public static MgSizeF Add(params MgSizeF[] sizes)
    {
      var retval = new MgSizeF();
    ...
    public static MgSizeF Subtract(params MgSizeF[] sizes)
    {
      var retval = new MgSizeF();
      foreach (var size in sizes)
      {
    ...
    public MgVector2 ToVector2()
    {
      return (MgVector2)this;
    }
    ...
    public MgSizeF Floor()
    {
      return new MgSizeF((int)Math.Floor(Width), (int)Math.Floor(Height));
    }
    ...
    /// </summary>
    /// <returns></returns>
    public MgSize ToSize()
    {
      return MgSize.Truncate(this);
    }
